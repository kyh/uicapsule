---
name: adapt
description: Adapt an existing web design to a different context — screen size, device, input method, connection, or usage posture — by rethinking the experience rather than scaling it. Use when making a layout responsive, porting desktop UI to mobile web (or back), supporting touch vs pointer vs keyboard, or reviewing how a component behaves across viewports.
---
...
When the adaptation feels native to each context, hand off to `better-interface` for the final review pass.
