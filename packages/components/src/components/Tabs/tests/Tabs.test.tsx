...
describe("Tabs", () => {
  test("renders correctly", async () => {
    ...
    expect(selectedItem.getAttribute("aria-controls")).toBe(
      selectedPanel.getAttribute("id")
    );

    const unselectedItem = items[1];
    const unselectedPanel = panels[1];
    expect(unselectedItem).toHaveAttribute("aria-selected", "false");
    expect(unselectedItem.getAttribute("aria-controls")).toBe(
      unselectedPanel.getAttribute("id")
    );
