...
const Backdrop = (props: T.Props) => {
  const { active, children, transparent, onClose, className, attributes } =
    props;
  ...
  const handleMouseUp = (event: React.MouseEvent<HTMLElement>) => {
    ...
    const shouldClose =
      isMouseDownValidRef.current && isMouseUpValid && !transparent;
  ...
  // Show backdrop after it was rendered
  React.useEffect(() => {
    if (!rendered) return;
