...
export const icon = () => (
	<Example>
		<Example.Item title="startIcon">
			<TextField name="Name" placeholder="Enter your name" value="Reshaped" startIcon={IconZap} />
		</Example.Item>
...
export const size = () => (
	<Example>
		<Example.Item title="size: medium">
			<TextField name="Name" placeholder="Enter your name" size="medium" startIcon={IconZap} />
		</Example.Item>

		<Example.Item title="size: large">
			<TextField name="Name" placeholder="Enter your name" size="large" startIcon={IconZap} />
		</Example.Item>

		<Example.Item title="size: xlarge">
			<TextField name="Name" placeholder="Enter your name" size="xlarge" startIcon={IconZap} />
		</Example.Item>
