...
export type UserThemeDefinition = {
	unit: Record<TUnit.Name, TUnit.Token>;
	fontFamily: Record<TFontFamily.Name, TFontFamily.Token>;
	fontWeight: Record<TFontWeight.Name, TFontWeight.Token>;
	font: Record<TFont.Name, TFont.Token>;
	color: Record<TColor.Name, TColor.Token>;
	duration: Record<TDuration.Name, TDuration.Token>;
	easing: Record<TEasing.Name, TEasing.Token>;
	shadow: Record<TShadow.Name, TShadow.Token>;
};
