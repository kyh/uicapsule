...
const theme: UserThemeDefinition = {
	...
	color: {
		...
		backgroundPrimary: { hex: "#5A58F2" },
		backgroundPrimaryFaded: { hex: "#E8E7FD", hexDark: "#1C1E55" },
		backgroundPrimaryHighlighted: { hex: "#7371F4" },
		...
		borderPrimary: { hex: "#4D4BE7", hexDark: "#9D9CF7" },
		borderPrimaryFaded: { hex: "#D2D0FB", hexDark: "#302D8F" },
