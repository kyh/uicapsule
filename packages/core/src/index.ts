...
export {
  default as Dismissible,
  DismissibleProps,
} from "components/Dismissible";
...
export {
  default as HiddenVisually,
  HiddenVisuallyProps,
} from "components/HiddenVisually";
...
export { default as UICapsule, UICapsuleProps } from "components/UICapsule";
...
export { UICapsuleConfig } from "types/config";
...
export {
  ...
  StackProps,
  StackItemProps,
} from "components/_deprecated/Stack";
