...
const calculatePosition: CalculatePosition = (
  ...
  switch (position) {
    ...
    case "top":
      left =
        centerBySize(originBounds.width, targetBounds.width) +
        originBounds.left;
      break;
  ...
  switch (position) {
    ...
    case "end":
      top =
        centerBySize(originBounds.height, targetBounds.height) +
        originBounds.top;
      break;
...
const defaultStyles: FlyoutStyles = {
  ...
  zIndex: "var(--ui-z-index-flyout)" as any,
};
...
const resetStyles: FlyoutStyles = {
  ...
  animation: "none",
  transition: "none",
  zIndex: "var(--ui-z-index-tooltip)" as any,
};
