...
const Field = ({
  ...
  <div
    // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- a fieldset brings its own box model (min-width, border, padding) and breaks the orientation layouts
    role="group"
    data-slot="field"
