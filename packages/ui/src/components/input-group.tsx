...
const InputGroup = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    ...
    // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- a fieldset brings its own box model (min-width, border, padding) and breaks the flex row
    role="group"
    className={cn(
...
const InputGroupAddon = ({
  ...
  // oxlint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- the click only forwards focus to the control, which keyboard users reach directly
  <div
    // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- a fieldset brings its own box model (min-width, border, padding) and breaks the flex row
    role="group"
