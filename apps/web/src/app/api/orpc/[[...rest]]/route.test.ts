...
/**
 * The CSRF plugin is this endpoint's cross-site defense, and it lives in
 ...
 * exporting OPTIONS turns the test suite red instead of silently shipping an
 * unguarded endpoint.
 */

const post = (headers: Record<string, string>) =>
  route.POST(
    new NextRequest("http://localhost:3000/api/orpc/user/me", {
      method: "POST",
