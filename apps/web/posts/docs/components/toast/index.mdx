...
Toasts support global options per screen region passed through the UICapsule provider.
...
<Grid>
  <CrossLink href="/content/docs/utilities/@uicapsule/components" title="UIC" />
</Grid>
