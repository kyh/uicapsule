...
export const bleed = () => (
	<Example title="Removes side borders and border radius when applied">
		...
		<Example.Item title={["responsive bleed", "[s] 4", "[m+] 0"]}>
			<View bleed={{ s: 4, m: 0 }} padding={4} borderColor="neutral">
				<Placeholder />
			</View>
		</Example.Item>
	</Example>
...
export const align = () => (
	<Example>
		...
		<Example.Item title={["align: baseline, direction: row", "Should have no visible effect"]}>
...
export const overflow = () => (
	<Example>
		...
		>
			<View height="100px" width="100px" shadow="base" borderRadius="medium" overflow="hidden">
