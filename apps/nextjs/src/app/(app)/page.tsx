...
const Page = async () => {
  ...
  return (
    <main>
      ...
      <div className="bg-border group grid gap-px border-b md:grid-cols-2 lg:h-auto lg:grid-cols-10 lg:grid-rows-2 lg:*:col-span-2 md:[&>*:first-child]:col-span-2 md:[&>*:first-child]:h-auto lg:[&>*:first-child]:col-span-4 lg:[&>*:first-child]:row-span-2 lg:[&>*:first-child]:h-auto">
        {content.map((c, index) => (
