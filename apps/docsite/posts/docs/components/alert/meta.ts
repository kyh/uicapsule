...
const meta: DocsMeta = {
	title: "Alert",
	description: "Prominent message related to the whole page or its specific area.",
	componentImport: 'import { Alert } from "reshaped";',
	typeImport: 'import type { AlertProps } from "reshaped";',
	relatedComponents: [
		{ name: "Card", url: "/content/docs/components/card" },
		{ name: "View", url: "/content/docs/utilities/view" },
	],
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-alert",
	properties: {
		base: {
			title: {
