...
const meta: DocsMeta = {
	...
	componentImport: 'import { TextField } from "reshaped";',
	typeImport: 'import type { TextFieldProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-textfield",
	relatedComponents: [{ name: "Text Area", url: "/content/docs/components/text-area" }],
	properties: {
		base: {
			name: {
			...
			placeholder: {
				type: ControlType.string,
				control: { defaultValue: "hello@reshaped.so" },
			},
			size: {
