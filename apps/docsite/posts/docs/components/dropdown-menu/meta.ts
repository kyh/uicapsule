...
const meta: DocsMeta = {
	...
	componentImport: 'import { DropdownMenu } from "reshaped";',
	typeImport: 'import type { DropdownMenuProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-dropdownmenu",
	relatedComponents: [
	...
	properties: {
		base: {
			...
			forcePosition: {
				...
				description: "Keep position the same even if menu doesn't fit into the viewport",
			},
			active: {
				type: ControlType.boolean,
				control: { ignore: true },
