...
const meta: DocsMeta = {
	...
	componentImport: 'import { Button } from "reshaped";',
	typeImport: 'import type { ButtonProps } from "reshaped";',
	relatedComponents: [
	...
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-button",
	properties: {
		base: {
			children: {
			...
			endIcon: { type: ControlType.icon, description: "SVG component definition" },
			color: {
				type: ControlType.enum,
				defaultValue: "neutral",
				control: { defaultValue: "primary" },
				options: ["neutral", "primary", "critical", "positive", "black", "white", "inherit"],
			},
			...
			onClick: { type: ControlType.function, args: [{ name: "event", type: "React.Event" }] },
			type: {
				type: ControlType.enum,
