...
const meta: DocsMeta = {
	...
	componentImport: 'import { Tabs } from "reshaped";',
	typeImport: 'import type { TabsProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-tabs",
	properties: {
		base: {
			children: {
