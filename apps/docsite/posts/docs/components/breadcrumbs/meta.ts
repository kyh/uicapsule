...
const meta: DocsMeta = {
	...
	componentImport: 'import { Breadcrumbs } from "reshaped";',
	typeImport: 'import type { BreadcrumbsProps } from "reshaped";',
	relatedComponents: [
		{ name: "Link", url: "/content/docs/components/link" },
		{ name: "Tabs", url: "/content/docs/components/tabs" },
	],
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-breadcrumbs",
	properties: {
		base: {
			...
			defaultVisibleItems: { type: ControlType.number, control: { defaultValue: 2 } },
			className: {
