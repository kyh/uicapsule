...
const meta: DocsMeta = {
	...
	componentImport: 'import { Modal } from "reshaped";',
	typeImport: 'import type { ModalProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-modal",
	relatedComponents: [{ name: "Backdrop", url: "/content/docs/utilities/backdrop" }],
	properties: {
		base: {
			children: {
		...
		subtitle: {
			children: {
				type: ControlType.slot,
				control: { mode: "text", defaultValue: "Update your personal infomation and save it" },
			},
		},
	},
};
