...
const meta: DocsMeta = {
	...
	componentImport: 'import { Progress } from "reshaped";',
	typeImport: 'import type { ProgressProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-progress",
	relatedComponents: [{ name: "Loader", url: "/content/docs/components/loader" }],
	properties: {
		base: {
			value: {
