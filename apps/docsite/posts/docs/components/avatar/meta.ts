...
const meta: DocsMeta = {
	...
	componentImport: 'import { Avatar } from "reshaped";',
	typeImport: 'import type { AvatarProps } from "reshaped";',
	relatedComponents: [{ name: "Image", url: "/content/docs/utilities/image" }],
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-avatar",
	properties: {
		base: {
			src: {
			...
			squared: { type: ControlType.boolean, description: "Shape of the avatar" },
			className: {
				type: ControlType.string,
