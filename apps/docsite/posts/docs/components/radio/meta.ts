...
const meta: DocsMeta = {
	title: "Radio",
	description: "Radio is a form element used for selecting one option from a list.",
	componentImport: 'import { Radio, RadioGroup } from "reshaped";',
	typeImport: 'import type { RadioProps, RadioGroupProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-radio",
	relatedComponents: [
	...
	properties: {
		base: {
			...
			value: { type: ControlType.string, control: { ignore: true, defaultValue: "ice-cream" } },
			checked: {
