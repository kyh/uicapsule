...
const meta: DocsMeta = {
	title: "Checkbox",
	description: "Form field used to select one or multiple values from the list.",
	componentImport: 'import { Checkbox, CheckboxGroup } from "reshaped";',
	typeImport: 'import type { CheckboxProps, CheckboxGroupProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-checkbox",
	relatedComponents: [
