...
const meta: DocsMeta = {
	...
	componentImport: 'import { TextArea } from "reshaped";',
	typeImport: 'import type { TextAreaProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-textarea",
	relatedComponents: [{ name: "Text Field", url: "/content/docs/components/text-field" }],
	properties: {
		base: {
			name: {
