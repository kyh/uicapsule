...
const meta: DocsMeta = {
	...
	componentImport: 'import { Popover } from "reshaped";',
	typeImport: 'import type { PopoverProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-popover",
	relatedComponents: [
