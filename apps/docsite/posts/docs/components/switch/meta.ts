...
const meta: DocsMeta = {
	...
	componentImport: 'import { Switch } from "reshaped";',
	typeImport: 'import type { SwitchProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-switch",
	relatedComponents: [
