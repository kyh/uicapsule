...
const meta: DocsMeta = {
	title: "Card",
	description: "Container to group information about subjects and their related actions",
	componentImport: 'import { Card } from "reshaped";',
	typeImport: 'import type { CardProps } from "reshaped";',
	relatedComponents: [{ name: "View", url: "/content/docs/utilities/view" }],
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-card",
	properties: {
		base: {
