...
const meta: DocsMeta = {
	...
	componentImport: 'import { Loader } from "reshaped";',
	typeImport: 'import type { LoaderProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/components-loader",
	properties: {
		base: {
			size: {
