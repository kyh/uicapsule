...
const meta: DocsMeta = {
	...
	componentImport: 'import { Image } from "reshaped";',
	typeImport: 'import type { ImageProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/utilities-image",
	relatedComponents: [
