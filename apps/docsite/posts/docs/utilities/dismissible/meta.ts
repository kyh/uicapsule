...
const meta: DocsMeta = {
	...
	componentImport: 'import { Dismissible } from "reshaped";',
	typeImport: 'import type { DismissibleProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/utilities-dismissible",
	properties: {
		base: {
			children: {
