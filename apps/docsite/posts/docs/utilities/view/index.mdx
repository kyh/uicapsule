...
View is the most used layout utility in UICapsule as it provides the most common functionality required for building layouts.
It can be used to apply common styles based on the design tokens provided by UICapsule and handles a lot of layout edge cases that you would have to solve yourself when using flexbox directly.
