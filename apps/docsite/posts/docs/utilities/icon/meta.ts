...
const meta: DocsMeta = {
	...
	componentImport: 'import { Icon } from "reshaped";',
	typeImport: 'import type { IconProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/utilities-icon",
	properties: {
		base: {
			svg: {
			...
			autoWidth: {
				...
				description: "Make icon boundaries based on the icon width instead of square",
				control: {
					ignore: true,
				},
			},
