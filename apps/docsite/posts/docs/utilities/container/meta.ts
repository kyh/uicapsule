...
const meta: DocsMeta = {
	title: "Container",
	description: "Responsive layout utility to control width of the main content area.",
	componentImport: 'import { Container } from "reshaped";',
	typeImport: 'import type { ContainerProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/utilities-container",
	properties: {
		base: {
			width: {
