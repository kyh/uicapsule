...
const meta: DocsMeta = {
	title: "Backdrop",
	description: "Faded-out layer used to emphasize a specific element on the page.",
	componentImport: 'import { Backdrop } from "reshaped";',
	typeImport: 'import type { BackdropProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/utilities-backdrop",
