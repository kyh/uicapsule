...
The UICapsule type scale includes various styles that support both expressive and application font sizes.
...
<View width="200px">
  <Text variant="body-2" maxLines={2}>
    UICapsule is a professionally crafted design system for product design and
