...
const meta: DocsMeta = {
	title: "Text",
	description: "Utility to apply typography styles responsively based on the viewport size.",
	componentImport: 'import { Text } from "reshaped";',
	typeImport: 'import type { TextProps } from "reshaped";',
	storybookUrl: "https://reshaped.so/storybook/?path=/story/utilities-text",
	properties: {
		base: {
			children: {
			...
			color: {
				type: ControlType.enum,
				options: ["neutral-faded", "primary", "positive", "critical", "disabled"],
			},
			align: {
				type: ControlType.enum,
