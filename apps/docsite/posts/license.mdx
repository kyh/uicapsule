---
title: Reshaped License
---

**Reshaped Library License** grants you a non-exclusive license and permission to use the Design system based on the number of purchased licenses.

**Reshaped Pro License** grants the same permissions to all Employees and Contractors of the Licensee to access and use the Design system.
...
- Design system is the code and design assets made available to the Licensee after purchasing an Reshaped license.
...
Reshaped's liability to you for costs, damages, or other losses arising from your use of the Design system — including third-party claims against you — is limited to a refund of your license fee. Reshaped may not be held liable for any consequential damages related to your use of the Design system.
