...
import { Container, Text, View, Badge, Button, ActionBar } from "reshaped";
	...
	return (
		<Container width="1056px">
			<View gap={8}>
				...
				<View gap={{ s: 4, l: 5 }} direction={{ s: "column", m: "row" }} align="stretch">
						...
						>
							<View direction="row" gap={9}>
								<img
									...
									className={s.image}
								/>
								<View gap={2} align="center" attributes={{ "aria-hidden": true }}>
						...
						>
							<View direction="row" gap={4}>
								<img
									...
									className={s.image}
								/>
								<View gap={3} align="center" attributes={{ "aria-hidden": true }}>
									<Button
										variant="outline"
										rounded
										size="large"
										...
										color="primary"
									/>
									<Button variant="outline" rounded startIcon={IconHeart} color="critical" />
									<Button variant="outline" rounded size="small" startIcon={IconHeart} />
								</View>
							</View>
						</BlockFeature>
					</View.Item>
