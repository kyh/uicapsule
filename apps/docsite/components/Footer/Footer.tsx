...
import { Container, Link, Divider, View, Hidden } from "reshaped";
...
const Footer = () => {
	return (
		<Container width="1056px">
			...
			>
				<View.Item grow>
					© 2020-{new Date().getFullYear()} Reshaped Design. All rights reserved.
				...
				<View gap={6} direction="row">
					...
					<Link
						...
						onClick={() => {
							ga.trackEvent({
								...
								action: "external_navigate_roadmap",
							});
						}}
					>
						Roadmap
					...
					<Link variant="plain" href="mailto:hello@reshaped.so">
						Contact us
					</Link>
				</View>
			</View>
