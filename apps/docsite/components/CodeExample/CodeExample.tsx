...
import * as Reshaped from "reshaped";
import { Placeholder, useTheme, View, Accordion } from "reshaped";
...
const CodeExample = (props: Props) => {
	...
	const parsedLanguage = className && (className.replace(/language-/, "") as any);
	...
	const isCodeOnly = isJSXCodeExample || (language !== "jsx" && language !== "tsx");
	...
	return (
		...
		>
			...
			>
				{!isCodeOnly && (
					<ComponentPreview height={isPreview ? 300 : undefined} centered={isPreview}>
						<LivePreview />
					</ComponentPreview>
				)}
