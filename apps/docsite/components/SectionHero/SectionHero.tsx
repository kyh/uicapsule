...
import { Container, Text, View, Button, useTheme } from "reshaped";
...
const themes = ["reshaped", "funky", "classic"];
				...
				<View gap={18}>
					<Container width="652px">
						<View gap={8} align="center">
							<Animation order={0}>
								<a
									href="https://www.producthunt.com/products/reshaped"
									target="_blank"
									rel="noreferrer"
								>
									{mounted && (
							...
							<View.Item gapBefore={5}>
								<Animation order={1}>
									<Text variant="featured-2" align="center" color="neutral-faded" as="p">
										Reshaped is a professionally crafted design system for everyday product
							...
							<Animation order={1}>
								<View gap={3} direction="row" justify="center">
									<NextLink href="/content/docs/getting-started/overview/" passHref>
