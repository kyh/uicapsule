...
const HorizontalGrid = () => (
	...
	>
		...
		<line y1={SINGLE_HEIGHT + GAP + 0.5} y2={SINGLE_HEIGHT + GAP + 0.5} x2="100%" />
		<line y1={SINGLE_HEIGHT * 2 + GAP - 0.5} y2={SINGLE_HEIGHT * 2 + GAP - 0.5} x2="100%" />

		<line y1={SINGLE_HEIGHT * 2 + GAP * 2 + 0.5} y2={SINGLE_HEIGHT * 2 + GAP * 2 + 0.5} x2="100%" />
	</svg>
);
			...
			<Hidden hide={{ s: true, l: false }}>
				{(className) => (
					<View.Item columns={4} key={2} className={className}>
						<View gap={5}>
							<Preview controls={controlsText} theme={appliedTheme} centered={false}>
								...
								<View.Item columns={6}>
									<Preview controls={controls} theme={appliedTheme}>
										<View direction="row" gap={0}>
											<Badge.Container>
												<Badge color="critical" size="small" className={s.animated}>
													5
												</Badge>
												<Avatar
													className={s.animated}
