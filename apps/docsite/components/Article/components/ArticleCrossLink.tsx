...
import { Card, Icon, View, Text } from "reshaped";
import IconArrow from "reshaped/icons/ArrowUpRight";
...
const ArticleCrossLink = (props: Props) => {
	...
	const renderCard = () => {
		return (
			<Card href={href} attributes={isExternal ? { target: "_blank" } : undefined} elevated>
				<View direction="row">
					<View.Item grow>
