...
const components: Record<string, (props: any) => any> = {
	h1: (props: { children: string }) => <ArticleHeading level={1}>{props.children}</ArticleHeading>,
	h2: (props: { children: string }) => <ArticleHeading level={2}>{props.children}</ArticleHeading>,
	h3: (props: { children: string }) => <ArticleHeading level={3}>{props.children}</ArticleHeading>,
	h4: (props: { children: string }) => <ArticleHeading level={4}>{props.children}</ArticleHeading>,
	p: ArticleText,
	code: (props: any) => {
