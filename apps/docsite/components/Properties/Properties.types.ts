...
} & (O["extraControlOptions"] extends Record<keyof O["extraControlOptions"], unknown>
	? RequiredControl<O>
...
export type StringControlProps = BaseControl<StringProperty, StringGeneric["value"]>;

export type SlotPropertyMode = "node" | "text";
type SlotNodeGeneric = {
	type: ControlType.slot;
	value: boolean;
	extraControlOptions: { mode?: Extract<SlotPropertyMode, "node">; height?: number };
};
...
type EnumGeneric = { type: ControlType.enum; value: string; extraOptions: { options: string[] } };
...
export type BooleanControlProps = BaseControl<BooleanProperty, BooleanGeneric["value"]>;
...
export type NumberControlProps = BaseControl<NumberProperty, NumberGeneric["value"]>;
...
export type ArrayControlProps = BaseControl<ArrayProperty, ArrayGeneric["value"]>;
...
export type ObjectControlProps = BaseControl<ObjectProperty, ObjectGeneric["value"]>;
...
export type ControlsProps = Pick<ModalProps, "active" | "onClose"> & {
	...
	onPropertyChange: (sectionName: string, args: { name: string; value?: unknown }) => void;
};
