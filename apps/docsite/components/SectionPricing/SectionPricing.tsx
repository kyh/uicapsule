...
import { Container, View, Text, Card, Badge, Button, Icon } from "reshaped";
...
const PricingCard = (props: T.PricingCardProps) => {
	const { badge, primary, title, price, priceSuffix, items, action, href, caption, onActionClick } =
		props;
				...
				<Container width="652px">
					<View gap={3}>
						...
						<Text variant="featured-3" align="center" as="p">
							Whether you’re looking for a library for a small side project or a base design system
							for a large product - we’ve covered it all
						</Text>
					</View>
				</Container>
				...
				<View gap={{ s: 4, l: 5 }} direction="row" align="stretch">
					<View.Item columns={{ s: 12, m: 6, l: 4 }}>
						<PricingCard
							...
							priceSuffix="/seat"
							items={[
								{ title: "Lifetime access", text: "Future updates and components" },
								{
									title: "Unlimited projects",
									text: "Library license is reserved for one person and unlimited projects",
								},
								{ title: "React library", text: "40+ components and utilities" },
								{
									title: "Figma library",
