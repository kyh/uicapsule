...
import { Container, Text, View, Button, Checkbox, Hidden } from "reshaped";
				...
				<Container width="852px">
					<View gap={3}>
						...
						<Text variant="featured-3" align="center" as="p">
							You have to set up a million things before you even start working on UI. <br />
							We took care of it so you can focus on your product.
						</Text>
					</View>
				</Container>

				<View gap={{ s: 4, l: 5 }} direction={{ s: "column", l: "row" }} align="stretch">
											...
											<View gap={5}>
												<View direction="row" gap={2}>
													<Hidden hide={{ s: true, l: false }}>
														<Button variant="outline" size="large" startIcon={IconLock} />
													</Hidden>
