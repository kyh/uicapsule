...
const menu: MenuItem[] = [
	{
		...
		items: [
			...
			{ url: "/content/docs/getting-started/principles", title: "Our principles" },
			{
				title: "React setup",
				items: [
					{
			...
			},
			{
				...
				items: [
					...
					{
						title: "Plugin",
						url: "/content/docs/getting-started/figma/plugin",
					},
				],
			},
			{
				title: "Integrations",
				items: [
					{ title: "Webpack", url: "/content/docs/getting-started/integrations/webpack" },
					{
						title: "Vite",
						url: "/content/docs/getting-started/integrations/vite",
					},
					// Waiting for https://github.com/parcel-bundler/parcel/issues/7492
					// {
					// 	title: "Parcel",
					// 	url: "/content/docs/getting-started/installation/parcel",
					// },
					{ title: "Next.js", url: "/content/docs/getting-started/integrations/next/next-13" },
					{ title: "Remix", url: "/content/docs/getting-started/integrations/remix" },
					{ title: "Gatsby", url: "/content/docs/getting-started/integrations/gatsby" },
					{ title: "Create React App", url: "/content/docs/getting-started/integrations/cra" },
				],
			},
			{
	...
	},
	{
		...
		items: [
			...
			{ url: "/content/docs/theming/scoped-theming", title: "Scoped theming", keywords: ["brand"] },
		],
	},
	{
		title: "Components",
		items: [
			...
			{ url: "/content/docs/components/card", title: "Card", keywords: ["box", "frame"] },
			{
				url: "/content/docs/components/carousel",
				title: "Carousel",
				keywords: ["slider"],
			},
			{ url: "/content/docs/components/checkbox", title: "Checkbox", keywords: ["input", "form"] },
			{ url: "/content/docs/components/divider", title: "Divider", keywords: ["separator"] },
			{
				url: "/content/docs/components/dropdown-menu",
				title: "Dropdown menu",
				keywords: ["listbox", "popover"],
			},
			{ url: "/content/docs/components/link", title: "Link", keywords: ["navigation"] },
			{
			...
			{ url: "/content/docs/components/overlay", title: "Overlay", keywords: ["scrim"] },
			{ url: "/content/docs/components/popover", title: "Popover", keywords: ["dropdown"] },
			{ url: "/content/docs/components/progress", title: "Progress" },
			{ url: "/content/docs/components/radio", title: "Radio", keywords: ["input", "form"] },
			{ url: "/content/docs/components/select", title: "Select", keywords: ["input", "form"] },
			{
			...
			{ url: "/content/docs/components/tooltip", title: "Tooltip", keywords: ["popover"] },
		],
	},
	{
		title: "Utilities",
		items: [
			{
				url: "/content/docs/utilities/reshaped",
			...
			{ url: "/content/docs/utilities/hidden", title: "Hidden", keywords: ["hide", "visibility"] },
			{
			...
			{ url: "/content/docs/utilities/text", title: "Text", keywords: ["typography"] },
			{
	...
	},
	{
		...
		items: [
			...
			{ url: "/content/docs/hooks/use-form-control", title: "useFormControl", keywords: ["input"] },
			{ url: "/content/docs/hooks/use-rtl", title: "useRTL", keywords: ["arabic", "hebrew"] },
...
const matchKeywords = (keywords: string[], filter?: string) => {
	...
	return !!keywords.filter((keyword) => keyword.toLowerCase().includes(filter.toLowerCase()))
		.length;
};
...
export const normalizeMenu = (options: { filter?: string } = {}) => {
	...
	const normalize = (item: MenuItem, extraKeywords: string[] = []): null | NormalizedMenuItem => {
		if (item.url) {
			const isMatching =
				matchKeywords([...(item.keywords || []), ...extraKeywords, item.title], filter) ||
	...
	return {
		data,
		list: menu.map((section) => normalize(section)).filter(Boolean) as NormalizedMenuItem[],
	};
};
...
export const getMenuItemData = (item: MenuItem | NormalizedMenuItem) => {
	...
	return item.id ? data[item.id] : item;
};
