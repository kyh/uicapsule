...
export const PinchGrid = () => {
  ...
  useEffect(() => {
    ...
    // Trackpad pinches arrive as ctrl+wheel. React's onWheel is passive, so a native
    // listener is needed to preventDefault — otherwise the browser zooms the page too.
        ...
        >
          {TILES.map((tile) => (
            <motion.div
              key={tile.id}
              layout
              transition={{ bounce: 0.18, duration: 0.55, type: "spring" }}
