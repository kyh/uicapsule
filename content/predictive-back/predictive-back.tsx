...
export const PredictiveBack = () => {
  ...
  const releaseGesture = () => {
    ...
    if (value > COMMIT) {
      ...
      void animate(progress, 0, { bounce: 0.25, duration: 0.45, type: "spring" });
    }
  };
  ...
  const openDetail = () => {
    setDetailOpen(true);
    progress.set(1);
    void animate(progress, 0, { bounce: 0.18, duration: 0.5, type: "spring" });
  };
  ...
  return (
    ...
    >
      ...
      {detailOpen && (
        <motion.div
          style={{ borderRadius: detailRadius, scale: detailScale, x: detailX }}
