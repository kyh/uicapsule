...
export const CircleToSearch = () => {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {match && (
          <motion.div
            ...
            className="absolute inset-x-3 bottom-16 z-30 rounded-[26px] bg-[#1d1e26]/95 p-4 shadow-2xl shadow-black/60 ring-1 ring-white/10 backdrop-blur-xl"
          >
      ...
      {searchMode && !match && (
        <p className="pointer-events-none absolute inset-x-0 top-5 z-20 text-center text-[12px] font-medium text-indigo-200/90">
          Circle anything
        </p>
      )}
    </div>
