...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("group relative flex gap-x-5", className)}
    {...props}
  />
));
FeedItem.displayName = "FeedItem";

const FeedIndicator = React.forwardRef<
  HTMLDivElement,
  React.ComponentPropsWithoutRef<"div">
...
const FeedContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentPropsWithoutRef<"div">
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("grow pb-8 group-last:pb-0", className)}
    {...props}
  />
));
FeedContent.displayName = "FeedContent";

const FeedLabel = React.forwardRef<
  HTMLParagraphElement,
  React.ComponentPropsWithoutRef<"p">
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("mb-1 text-xs text-muted-foreground-2", className)}
    {...props}
  />
));
FeedLabel.displayName = "FeedLabel";

const FeedTitle = React.forwardRef<
  HTMLParagraphElement,
  React.ComponentPropsWithoutRef<"p">
>(({ className, ...props }, ref) => (
  <p
...
const FeedDescription = React.forwardRef<
  HTMLParagraphElement,
  React.ComponentPropsWithoutRef<"p">
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("mt-1 text-sm text-muted-foreground-2", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    className={cn("ms-6 mt-3 list-disc space-y-1.5", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <li
    ref={ref}
    className={cn("ps-1 text-sm text-muted-foreground-2", className)}
    {...props}
  />
));
