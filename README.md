...
- Browse: https://uicapsule.com
- Request one: https://uicapsule.com/request
- Install: `npx shadcn@latest add @uicapsule/<slug>`

Running it locally, verifying, and the content pipeline: see [AGENTS.md](AGENTS.md).
